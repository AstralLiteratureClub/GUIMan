...
public class ClickableBuilder implements Cloneable, ClickableLike {
	...
	public ClickableBuilder hideItemFlags(){
		GUIManInitializer.getItemUtils().hideFlags(itemStack);
		return this;
	}
	...
	public ClickableBuilder hideTooltip(){
		if (!GUIManInitializer.isOrNever("1.20.5")){
			throw new IllegalStateException("Only 1.20.5 or higher minecraft can hide the tooltip");
		}
		GUIManInitializer.getItemUtils().hideTooltip(itemStack);
		return this;
	}
	...
	public ClickableBuilder hideDurability() {
		GUIManInitializer.getItemUtils().hideDurability(itemStack);
		return this;
	}
	 ...
	 */
	@NotNull
	public ClickableBuilder modifyItem(@NotNull Function<ItemStack, ItemStack> itemFunc){
