...
import bet.astral.guiman.core.inventory.gui.builders.InventoryGUIBuilder;
import bet.astral.guiman.core.inventory.gui.builders.InventoryGUIPatternBuilder;
...
public class InventoryGUI implements bet.astral.guiman.api.inventory.gui.InventoryGUI {
	...
	@Override
	public Collection<bet.astral.guiman.api.inventory.clickable.ClickableLike> getClickable(int slot) {
		return List.of();
	}
	...
	public void open(Player player) {
		CompletableFuture.runAsync(()->{
			try {
				GUIManInitializer guiMan = GUIManInitializer.GUIMAN;
