...
import bet.astral.guiman.core.inventory.gui.ClickInventory;
...
public class InventoryGUIBuilder implements Cloneable {
	...
	/**
	 * Creates chest inventory gui builder. Chest inventories is the most supported inventory type of GUIManInitializer
	 *
	 * @param rows          how many rows
