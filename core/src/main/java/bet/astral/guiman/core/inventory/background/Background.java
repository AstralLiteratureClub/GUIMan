...
import bet.astral.guiman.core.inventory.background.builders.BorderPatternBuilder;
import bet.astral.guiman.core.inventory.background.builders.CheckeredPatternBuilder;
...
public abstract class Background implements Iterable<ClickableLike> {
	 ...
	 */
	@Contract("_ -> new")
	public static @NotNull Background tooltip(ItemStack material) {
	 ...
	 */
	@Contract("_ -> new")
	public static @NotNull Background tooltip(ClickableLike clickable) {
	 ...
	 */
	@Contract("_ -> new")
	public static @NotNull Background noTooltip(Material material) {
		return noTooltip(new ItemStack(material));
	}
	/**
	 * Returns single item background with given material and without hover tooltip.
	 *
	 ...
	 */
	@Contract("_ -> new")
	public static @NotNull Background noTooltip(ItemStack material) {
