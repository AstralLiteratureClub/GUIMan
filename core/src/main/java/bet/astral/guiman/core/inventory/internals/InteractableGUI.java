...
import bet.astral.guiman.core.inventory.clickable.ClickableProvider;
	...
	public InteractableGUI(@NotNull InventoryGUI gui, @NotNull Player player) {
		...
		if (gui.getNameTranslation() == null && gui.getName() == null) {
			...
			if (gui.getNameTranslation() != null && gui.getMessenger() == null){
                ...
                GUIManInitializer.GUIMAN.getPlugin().getSLF4JLogger().warn("Messenger is not set for inventory {}, {}", gui.getNameTranslation().translationKey(), new Throwable());
