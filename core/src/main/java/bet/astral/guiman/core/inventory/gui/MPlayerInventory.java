...
public class MPlayerInventory extends PlayerInventory {
	 ...
	 */
	public MPlayerInventory(@NotNull Inventory gui, @NotNull Player player) {
		super(gui, player);
	}

	@Override
	protected Component getName(Inventory gui, Player player) {
		if (gui instanceof MInventory mGUI && mGUI.hasComponentTitle()) {
